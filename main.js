...
var MindDumpSettingTab = class extends import_obsidian5.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian5.Setting(containerEl).setName(t("saveFolder", this.plugin.lang)).setDesc(t("saveFolderDesc", this.plugin.lang)).addText((text) => text.setPlaceholder("MindDump").setValue(this.plugin.settings.saveFolder).onChange((value) => {
      this.plugin.settings.saveFolder = value.trim() || "MindDump";
      this.debouncedSave();
    }));
    new import_obsidian5.Setting(containerEl).setName(t("attachmentsFolder", this.plugin.lang)).setDesc(t("attachmentsFolderDesc", this.plugin.lang)).addText((text) => text.setPlaceholder("MindDump/attachments").setValue(this.plugin.settings.attachmentsFolder).onChange((value) => {
    ...
    this.multiFileFormatSetting = new import_obsidian5.Setting(containerEl).setName(t("fileFormat", this.plugin.lang)).setDesc(t("fileFormatDesc", this.plugin.lang)).addText((text) => text.setPlaceholder("minddump-YYYYMMDD").setValue(this.plugin.settings.multiFileFormat).onChange((value) => {
    ...
    this.fixedTagSetting = new import_obsidian5.Setting(containerEl).setName(t("fixedTag", this.plugin.lang)).setDesc(t("fixedTagDesc", this.plugin.lang)).addText((text) => text.setPlaceholder("minddump").setValue(this.plugin.settings.fixedTag).onChange((value) => {
