...
function mountQuickComposeCard(options) {
  ...
  textarea.addEventListener("paste", async (e) => {
    ...
    if (imageFiles.length === 0)
      return;
    e.preventDefault();
    const plain = (_b = (_a2 = e.clipboardData) == null ? void 0 : _a2.getData("text/plain")) != null ? _b : "";
  ...
  "src/capture-modal.ts"() {
    ...
    CaptureModal = class extends import_obsidian3.Modal {
      ...
      syncCaptureSaveReady() {
        if (!this.captureSaveBtn || !this.contentInput)
          return;
        const ready = this.contentInput.value.trim().length > 0 || this.selectedAttachments.length > 0;
